...
${White}                                        | |       __/ |
${White}     Hola! Crea Gmail ilimitados         |_|      |___/ \n
         \e[0;96mCreado por: ${Red}Angel Del Villar\n\n"
}

email () {

##### Input Email, validation based on regular expression #####
read -p $'\e[1;97m[\e[1;92m*\e[1;97m]\e[1;92m Introduzca la dirección de correo electrónico : \e[1;97m' email
if [[ $email =~ ^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$ ]]; then
read -p $'\e[1;97m[\e[1;92m*\e[1;97m]\e[1;92m Número de correos a generar : \e[1;97m' number

##### Extracting name and domain from email #####
name=`echo $email | cut -d "@" -f 1`
domain=`echo $email | cut -d "@" -f 2`
echo -e "$White[${Red}!$White]$Red Generando :${White}\e[0;97m"
sleep 1
...
read -p $'\n\e[1;97m[\e[1;92m*\e[1;97m]\e[1;92m ¿Quieres guardar los resultados? (y/n) : \e[1;97m' save_output
...
cp $name.lst output
echo -e "$White[${Yellow}*$White]$Yellow guardada datos en : ${White}output/$name.lst"
...
echo -e "$White[${Red}!$White]$Red Dirección de correo electrónico no válida"
email 
fi
}
banner
